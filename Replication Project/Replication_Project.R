...
figure_1A
pdf("figure_1A.pdf", width = 6, height = 5)  # adjust width/height as needed
figure_1A
dev.off()
...
figure_1B
figure_1B
pdf("figure_1B.pdf", width = 6, height = 5)  # adjust width/height as needed
figure_1B
dev.off()
...
# Modified regression with interactions
library(estimatr)
library(dplyr)
library(ggplot2)
...
print(p)
pdf("Figure_Interaction_Age.pdf", width = 8, height = 6)
print(p)
dev.off()
